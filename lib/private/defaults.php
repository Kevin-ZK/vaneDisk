...
class OC_Defaults {
	...
	function __construct() {
		...
		$this->defaultEntity = '氢氧云盘'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'vaneDisk'; /* short name, used when referring to the software */
		$this->defaultTitle = 'vaneDisk'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'http://vanecloud.com/';
		$this->defaultSyncClientUrl = 'https://owncloud.org/sync-clients/';
		$this->defaultiOSClientUrl = 'https://itunes.apple.com/us/app/owncloud/id543672169?mt=8';
		$this->defaultiTunesAppId = '543672169';
		$this->defaultAndroidClientUrl = 'https://play.google.com/store/apps/details?id=com.owncloud.android';
		$this->defaultDocBaseUrl = 'http://vanecloud.com/';
