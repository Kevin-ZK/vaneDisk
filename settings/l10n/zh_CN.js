OC.L10N.register(
    ...
    "Personal info" : "个人信息",
    "Full name" : "全名",
    "You are member of the following groups:" : "您属于以下分组：",
    ...
    "Remove image" : "移除图片",
    "Either png or jpg. Ideally square but you will be able to crop it. The file is not allowed to exceed the maximum size of 20 MB." : "png 或 jpg。正方形比较理想，但你也可以之后对其进行裁剪。图片大小必须小于20 MB。",
    ...
    "Allow users to send mail notification for shared files to other users" : "允许用户向其他人发送邮件通知分享文件",
    "Allow username autocompletion in share dialog. If this is disabled the full username needs to be entered." : "在分享界面允许用户名自动补齐。 如果该选项被禁用，需要输入用户完整姓名",
    "Email server" : "邮件服务器",
    "Enable server-side encryption" : "启用服务器端加密",
    "Download logfile" : "下载日志文件",
    "Not enabled" : "未启用",
    "Experimental apps are not checked for security issues, new or known to be unstable and under heavy development. Installing them can cause data loss or security breaches." : "测试中的应用还未经过严格的安全验证，可能存在潜在的风险。",
    "Enable experimental apps" : "启用测试中的应用",
    "Server Status" : "服务器状态",
    "Tips & tricks" : "提示和技巧",
    "Show storage location" : "显示存储位置",
    "Show last log in" : "显示最后登录",
    "Show email address" : "显示邮箱地址",
    "Username" : "用户名",
    "Create" : "创建",
    "Search Users" : "搜索用户",
    ...
    "Add Group" : "增加组",
    "Group Admin for" : "组管理员",
    "Send email to new user" : "发送邮件给新用户",
    "no group" : "未分配",
