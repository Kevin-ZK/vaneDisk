OC.L10N.register(
    ...
    "Download" : "下载",
    "Download %s" : "下载 %s",
    "A file or folder was shared from <strong>another server</strong>" : "一个文件或文件夹被<strong>另一台服务器</strong>所分享",
    "A public shared file or folder was <strong>downloaded</strong>" : "一个外链分享的文件或文件夹被<strong>下载</strong>",
    "Direct link" : "直接链接"
},
"nplurals=1; plural=0;");
