OC.L10N.register(
    ...
    "You don’t have permission to upload or create files here" : "您没有权限在这里上传或创建文件",
    ...
    "No favorites" : "无收藏",
    "Limit notifications about creation and changes to your <strong>favorite files</strong> <em>(Stream only)</em>" : "您<strong>收藏的文件</strong>被修改 <em>（仅限于流）</em>",
