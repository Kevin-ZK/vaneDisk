OC.L10N.register(
    ...
    "Share" : "共享",
    "SMB / CIFS using OC login" : "SMB / CIFS 使用 vaneDisk 登录信息",
    "URL" : "URL",
    ...
    "<b>Note:</b> \"%s\" is not installed. Mounting of %s is not possible. Please ask your system administrator to install it." : "<b>警告：</b>并未安装 \"%s\"，因此无法挂载 %s。请与您的管理员联系进行安装。",
